...
Original file is located at
    https://colab.research.google.com/drive/108Jcqv71SF6OG_7RStT3xhXxKHBkraKh
"""
...
consumerKey='89NrJyuubbt2kGmJ76ET18ArR' #confidential
consumerSecret='zzJlqHPeHYGy4q4QLvSpXPDYcivtlgr25c8aIKYOEnoQbyOza8'  #confidential
accessToken='1327238840751435779-atKRmD1Ay5BUIXUZ4nNRTdAtMfDaiB'  #confidential
accessTokenSecret='ZUuhOzkEM714ncECpdJFqwiQKgwPBf2vfM3fCqwr98Xsb' #confidential
...
def app():
	...
	st.title("Rhapsody Tweet Analyzer  🌎")
	...
	if choice=="Tweet Analyzer":
		...
		st.subheader("Analyze the tweets of your favourite rhapsody of realities")

		st.subheader("This tool performs the following tasks :")

		st.write("1. Fetches the 10 most recent tweets from the given twitter rhapsotweets")
		...
		raw_text = st.text_area("Enter the exact twitter handle of the rhapsody (without @)")
		...
		user_name = st.text_area("*Enter the exact twitter handle of the Rhapsody (without @)*")
	...
	st.subheader(' ------------------------Created By :  Lereko Qholosha ---------------------- :smile:')
